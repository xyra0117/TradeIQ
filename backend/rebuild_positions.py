...
_spec = importlib.util.spec_from_file_location('app_fees', os.path.join(os.path.dirname(__file__), 'app.py'))
...
def backup_positions():
    ...
    backup_path = os.path.join(os.path.dirname(__file__), f'positions_backup_{ts}.json')
