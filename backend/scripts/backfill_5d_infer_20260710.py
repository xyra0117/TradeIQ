...
原理: 5 日累计 = 7/10 + 7/7 + 7/8 + 7/9 + 7/13 (最近 5 个交易日)
      → 7/10 当日值 = 5 日累计 - 7/7 - 7/8 - 7/9 - 7/13 的当日值 (DB 已有)
...
NEIGHBOR_DATES = ['20260707', '20260708', '20260709', '20260713']
...
def fetch_neighbor_sums():
    """从 DB 查 7/7+7/8+7/9+7/13 四天的当日主力净流入, 按 ts_code 求和."""
